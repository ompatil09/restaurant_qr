        ...
        <div className="container-custom">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-text-secondary">
              Start free, then upgrade when your restaurant is ready.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {Object.entries(APP_CONFIG.plans).map(([key, plan]) => (
              <div
                key={key}
                className={`card ${
                  key === "restaurant_plan" ? "ring-2 ring-accent relative" : ""
                }`}
              >
                {key === "restaurant_plan" && (
                ...
                <Link to="/register">
                  <Button
                    variant={key === "restaurant_plan" ? "primary" : "outline"}
                    fullWidth
                  >
                    {plan.price === 0 ? "Start Free" : "Get Restaurant Plan"}
                  </Button>
                </Link>
              </div>
            ))}
